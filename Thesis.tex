...
%-----<<<<<<<<<<<< DEFINITIONS >>>>>>>>>>>>----- % for special characters of Czech/Slovak lang. use LaTeX commands only such as acute accent \'{o}, caron over the letter \v{s}, etc..
...
\def \Publisher {Charles University}
%-----<<< --------------------------------- >>>-----
