...
% \emph{The relationship between finance and inequality is an empirical question}

% \textcite{cihaksahay2020} provide evidence of association between periods of financial upheaval with rising inequality. Mind that the argument of this relationship goes the opposite direction. More inequality results in more vulnerable financial systems.

% What about between-country and global inequality?

% Financial inclusion is strongly associated with lower inequality, measured both as access to payment services, and access to credit. 

% Income inequality is significantly correlated with financial inequality.

% Field experiments provide direct evidence about the causal linkages and positive relationship between access to savings and payment services and an increase in income of the lower-income households.

% \textbf{Explanations for deepening and rising top income shares:} high compensation in the financial sector when financial industry booms, e.g. early 2000s and early 20th century before the Great Depression \parencite{philippon2012wages}, during the times of expanding household credit and rising asset management fees \parencite{greenwood2013growth}, higher compensation in the relatively more risky part of financial industry \parencite{axelson2015wall}, and increasing managerial rent extraction due to higher market power and size of banks.

% The evidence is that inequality declines during the crisis and then rises again in the follow-up.

% Limitations of the study: within-country inequality, direction of causality, precision of inequality indicators, financial sector indicators are only proxies, we abstract from fintech, which is likely to improve access to finance, above all.
